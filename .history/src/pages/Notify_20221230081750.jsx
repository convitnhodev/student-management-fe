...
export default function Notify() {
  ...
  return (
    ...
    <div className="flex flex-col items-center pt-16 w-full h-full">
      <h1 className="text-4xl font-bold m-5 text-violet-700">Notification</h1>
      <div className=" min-w-min shadow-md sm:rounded-lg ">
        <table className=" text-sm text-left text-violet-500 h-3/5 overflow-x-auto">
