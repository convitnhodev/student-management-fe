...
export default function Notify() {
  ...
  return (
    ...
    <div className="flex flex-col items-center pt-10 w-full h-full">
      ...
      <button className="bg-violet-500 mt-3 arounded  hover: text-violet-700  text-white">
        <div className=" m-1 p-2.5 flex items-center px-4 duration-300 cursor-pointer hover:text-violet-600 text-white">
