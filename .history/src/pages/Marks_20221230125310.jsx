...
export default function Marks() {
  ...
  const editButton = (
    <button
      onClick={handleClick}
      className="ml-2 text-xl bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded"
    >
      Sửa
    </button>
  );
  ...
  const cancelButton = (
    <button
      onClick={handleClick}
      className="ml-2 text-xl bg-red-500 hover:bg-red-700 text-white py-1 px-2 rounded"
    >
      Huỷ
    </button>
  );
  ...
  const saveButton = (
    <button
      onClick={handleClick}
      className="ml-2 text-xl bg-green-500 hover:bg-green-700 text-white py-1 px-2 rounded"
    >
      Lưu
    </button>
  );
