...
export default function Notify() {
  ...
  return (
    <div className="flex flex-col items-center pt-10 w-full h-full">
      ...
      <div>
        <button className="bg-violet-400 mt-3 rounded mr-2 hover:text-violet-700 text-white shadow-md">
        ...
        <button className="bg-violet-400 mt-3 rounded ml-2 hover:text-violet-700 text-white shadow-md">
          <div className=" m-1 p-2.5 flex items-center px-4 duration-300 cursor-pointer ">
