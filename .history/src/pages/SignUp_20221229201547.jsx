...
export default function SignUp() {
  ...
  const [errPass, setErrPass] = useState("");
	...
	const handlePass=(e)=>{
		if(values.pass_word<6 ){
			setErrPass("Mật khẩu phải có ít nhất 6 ký tự")
		}
		if(values.pass_word!== e.target.value.repassword){
			setErrPass("Mật khẩu không trùng khớp")
		}
	}
            ...
            <form>
              ...
              <div className="mb-3">
                <input
                  ...
                  onChange={handleChange}
                />
                {/* {err.errPass && <p className="text-red-500">{err.errPass}</p>} */}
              </div>
              <div className="mb-3">
                <input
                  type="text"
                  ...
                  onChange={handleChange}
                />
                {/* {err.errEmail && <p className="text-red-500">{err.errEmail}</p>} */}
              </div>
              <div className="mb-3">
                <input
                  type="text"
                  ...
                  onChange={handleChange}
                />
                {/* {err.errPhone && <p className="text-red-500">{err.errPhone}</p>} */}
              </div>
