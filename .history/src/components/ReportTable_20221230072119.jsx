...
export default function ReportTable({ data }) {
  ...
  return (
    <>
      ...
      <div className="fixed top-1 right-1 m-1 p-2.5 items-center px-4 duration-300 cursor-pointer hover:bg-violet-900 ">
        <FaBell className="sidebar-icon-icon text-violet-500" size={30} />
      </div>
    </>
  );
}
